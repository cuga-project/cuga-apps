"""CLI helpers for the ibm_whats_new skill — stdlib only.
...
The agent invokes this script as a subprocess and parses JSON from stdout:
    ...
    python scripts/ibm_news_tools.py fetch_webpage 'https://cloud.ibm.com/docs/...'
...
_UA = {
    "User-Agent": "ibm-whats-new-skill/1.0 (https://skills.sh)",
...
_USAGE = """\
usage:
  python scripts/ibm_news_tools.py web_search <query> [max_results=6]
  python scripts/ibm_news_tools.py fetch_webpage <url> [max_chars=8000]

"""CLI helpers for the web_researcher skill — stdlib only.

The agent invokes this script as a subprocess and parses JSON from stdout:

    python scripts/research_tools.py web_search 'EV battery recycling 2026' 6
...
_UA = {
    "User-Agent": "web-researcher-skill/1.0 (https://skills.sh)",
...
_USAGE = """\
usage:
  python scripts/research_tools.py web_search <query> [max_results=6]
  python scripts/research_tools.py fetch_webpage <url> [max_chars=8000]

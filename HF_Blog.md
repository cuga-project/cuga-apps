...
- [Live app gallery + MCP Tool Explorer](https://cuga-agent-apps.1gxwxi8kos9y.us-east.codeengine.appdomain.cloud/) — every app behind a launch button, plus a form to call each hosted MCP tool directly
